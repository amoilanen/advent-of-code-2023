...
fn main() {
    ...
    println!("Day 9:");
    let day_9_input_parsed = day9::parse(day9::INPUT);
    ...
    println!("Day 12");
    let day_12_input_parsed = day12::parse(day12::INPUT).unwrap();
    println!("{:?}", day12::solution_part_1(&day_12_input_parsed));
    println!("{:?}", day12::solution_part_2(&day_12_input_parsed));
}